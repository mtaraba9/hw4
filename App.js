    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.currentWeather}>
          <Text> {this.state.currentIcon && (<Icon style = {styles.currentIcon} size={100} name={icon(this.state.current)} />)} </Text>
          <Text style={styles.locationText}>{this.state.locationName}</Text>
          <Text> {this.state.currentIcon && (<Text style={styles.currentTemperature}>{Math.round(this.state.currentTemperature)}</Text>)}</Text>
...
// <View style={styles.forecastDay} key="forecast1">
//   <Text style={styles.forecastIcon}><Icon size={30} name={icon(this.state.forecast[1].icon)} /></Text>
//   <Text style={styles.forecastTemperature}>{Math.round(this.state.forecast[1].temperatureHigh)}</Text>
// </View>
//
// <View style={styles.forecastDay} key="forecast1">
//   <Text style={styles.forecastIcon}><Icon size={30} name={this.state.forecast[1] && (icon(this.state.forecast[1].icon))} /></Text>
//   <Text style={styles.forecastTemperature}>{this.state.forecast[1] && (Math.round(this.state.forecast[1].temperatureHigh))}</Text>
// </View>


// <View style={styles.forecastDay} key="forecast1">
//   <Text style={styles.forecastIcon}>
//     <Icon size={30} name={this.state.forecast[1] && (icon(this.state.forecast[1].icon))} />
//     <Icon size={30} name={this.state.forecast[1] && (icon(this.state.forecast[2].icon))} />
//     <Icon size={30} name={this.state.forecast[1] && (icon(this.state.forecast[3].icon))} />
//     <Icon size={30} name={this.state.forecast[1] && (icon(this.state.forecast[4].icon))} />
//     <Icon size={30} name={this.state.forecast[1] && (icon(this.state.forecast[5].icon))} />
//   </Text>
//   <Text style={styles.forecastTemperature}>
//     {this.state.forecast[1] && (Math.round(this.state.forecast[1].temperatureHigh))}
//     {this.state.forecast[1] && (Math.round(this.state.forecast[2].temperatureHigh))}
//     {this.state.forecast[1] && (Math.round(this.state.forecast[3].temperatureHigh))}
//     {this.state.forecast[1] && (Math.round(this.state.forecast[4].temperatureHigh))}
//     {this.state.forecast[1] && (Math.round(this.state.forecast[5].temperatureHigh))}
//   </Text>
// </View>
